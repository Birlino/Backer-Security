    ...
    async execute(interaction){
        if(!interaction.isButton()) {return}
            ...
            if (interaction.customId == "setup") {
                ...
                .setDescription('Ticket aperto per **SETUP** uno staffer sarà da te a momenti perfavore attendi!')
                ...
                .addComponents(
                  ...
                  .setCustomId('close-ticket-setup')
                  .setLabel('close')
            ...
            if (interaction.customId == "close-ticket-setup") {
            if(!interaction.member.roles.cache.has(config.staff)){
              return interaction.reply({content: `Non hai il ruolo `+ "<@&"+(config.staff)+">", ephemeral: true })
                ...
                const row = new Discord.MessageActionRow()
                  .addComponents(
                    new Discord.MessageButton()
                    .setCustomId('confirm-close-setup')
                    .setLabel('Close')
                    .setStyle('DANGER'),
                    new Discord.MessageButton()
                    .setCustomId('no-setup')
                    .setLabel('Cancel')
                    .setStyle('SECONDARY'),
                  );
                ...
                collector.on('collect', i => {
                  if (i.customId == 'confirm-close-setup') {
                    ...
                    chan.edit({
                      ...
                      .then(async () => {
                        ...
                        const row = new Discord.MessageActionRow()
                          .addComponents(
                            new Discord.MessageButton()
                            .setCustomId('delete-ticket-setup')
                            .setLabel('Delete')
              ...
              if (interaction.customId == "delete-ticket-setup") {
                const guild = client.guilds.cache.get(interaction.guildId);
                const chan = guild.channels.cache.get(interaction.channelId);
